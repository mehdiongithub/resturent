        ...
        <div class="col-md-12">
            <form id="product-form" class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" value="{{$data->name}}" name="name" disabled class="form-control" id="inputName4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" value="{{$data->price}}" disabled name="price" class="form-control" id="inputPrice4">
                ...
                <div class="col-md-6">
                  ...
                  <div class="photo-upload-container">
                    <input type="file" disabled id="photo" name="photo" accept="image/*" class="photo-input" onchange="previewImage(event)">
