        ...
        <div class="col-md-12">
            <form id="product-form" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="price" class="form-control" id="inputPrice4">
                ...
                <div class="col-md-12 d-flex justify-content-end">
                    ...
                    <button id="clear" type="button" class="btn btn-danger btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#resetModal" data-form-id="product-form">
                      Clear
                  </button>
