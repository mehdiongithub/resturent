...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="{{asset('assets/auth/img/kaiadmin/favicon.ico')}}"
      type="image/x-icon"
    />
    ...
    <!-- Fonts and icons -->
    <script src="{{asset('assets/auth/js/plugin/webfont/webfont.min.js')}}"></script>
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["{{asset('assets/auth/css/fonts.min.css')}}"],
        },
        active: function () {
        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="{{route('dashboard')}}" class="logo">
              <img
                src="{{asset('assets/auth/img/kaiadmin/logo_light.svg')}}"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#forms">
                  <i class="fas fa-chart-bar"></i> <!-- Reports Icon -->
                  <p>Reports</p>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="forms/forms.html">
                        <i class="fas fa-dollar-sign"></i> <!-- Sell Icon -->
                        <span class="sub-item">Sell</span>
                      </a>
                    </li>
                    <li>
                      <a href="forms/forms.html">
                        <i class="fas fa-cart-arrow-down"></i> <!-- Purchase Icon -->
                        <span class="sub-item">Purchase</span>
                      </a>
                    </li>
                    <li>
                      <a href="forms/forms.html">
                        <i class="fas fa-wallet"></i> <!-- Expense Icon -->
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assets/auth/img/jm_denis.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assets/auth/img/chadengle.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assets/auth/img/mlane.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assets/auth/img/talha.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assets/auth/img/profile2.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="{{asset('assets/auth/img/profile.jpg')}}"
                        alt="..."
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <form id="logoutForm" action="{{ route('logout') }}" method="POST">
                          @csrf
                          <button class="dropdown-item" type="submit" id="logout_btn">Logout</button>
                      </form>                      
                      </li>
                    </div>
                  </ul>
...
<!-- jQuery Sparkline -->
<script src="{{ asset('assets/auth/js/plugin/jquery.sparkline/jquery.sparkline.min.js') }}"></script>
...
<!-- Sweet Alert -->
<script src="{{ asset('assets/auth/js/plugin/sweetalert/sweetalert.min.js') }}"></script>
